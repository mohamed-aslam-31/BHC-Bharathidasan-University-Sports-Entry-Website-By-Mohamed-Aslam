    ...
    if (isEdit) {
      ...
      getStudent(id).then(res => {
        ...
        setForm({
          year: s.YEAR || '',
          rollNo: s.ROLL_NO || '',
          nameOfTheGame: s.NAME_OF_THE_GAME || '',
          gender: s.GENDER || 'MALE',
          studentName: s.NAME_OF_THE_SPORTSPERSON || '',
          fatherName: s.FATHERS_NAME || '',
          motherName: s.MOTHER_NAME || '',
          dob: s.DATE_OF_BIRTH || '',
          nameOfExam: s.NAME_OF_EXAM || '',
          dateAndYear: s.DATE_AND_YEAR || '',
          presentClass: s.PRESENT_CLASS || '',
          nameOfThePresentClass: s.NAME_OF_THE_PRESENT_CLASS || '',
          durationOfCourse: s.DURATION_OF_COURSE || '',
          university: s.UNIVERSITY || '',
          presentCourse: s.PRESENT_COURSE || '',
          graduateCourse: s.GRADUATE_COURSE || 'NIL',
          pgCourse: s.P_G_COURSE || 'NIL',
          previousCourse: s.PREVIOUS_COURSE || '',
          address: s.ADDRESS || '',
